...
namespace tests.Middleware
{
    ...
    {
        private const string ConsumerName = "EventAPIConsumer";
        ...
        public ProviderStateMiddleware(RequestDelegate next)
        {
            ...
            {
                {
                    "a request to check the api response",
                    RemoveAllData
                },
                {
                    "There is data",
        ...
        {
            Console.WriteLine("SET UP THE REQUESTED FIXTURE ID FROM CONSMER HERE");
        }
