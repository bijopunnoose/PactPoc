# -*- encoding: utf-8 -*-
# stub: pact_broker-client 1.13.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<conventional-changelog>.freeze, [">= 0"])
      ...
      s.add_dependency(%q<conventional-changelog>.freeze, [">= 0"])
